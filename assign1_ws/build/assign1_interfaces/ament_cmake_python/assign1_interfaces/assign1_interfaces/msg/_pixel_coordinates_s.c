...
bool assign1_interfaces__msg__pixel_coordinates__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("assign1_interfaces.msg._pixel_coordinates.PixelCoordinates", full_classname_dest, 58) == 0);
  }
  assign1_interfaces__msg__PixelCoordinates * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of PixelCoordinates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("assign1_interfaces.msg._pixel_coordinates");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PixelCoordinates");
