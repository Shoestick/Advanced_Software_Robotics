...
static const _PixelCoordinates_type_support_symbol_names_t _PixelCoordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assign1_interfaces, msg, PixelCoordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, assign1_interfaces, msg, PixelCoordinates)),
  }
};
...
{
  return &::assign1_interfaces::msg::rosidl_typesupport_cpp::PixelCoordinates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, assign1_interfaces, msg, PixelCoordinates)() {
  return get_message_type_support_handle<assign1_interfaces::msg::PixelCoordinates>();
}
